...
const MultiTagInput = ({ tags = [], onChange, options = [], placeholder = "輸入或從清單選擇..." }) => {
    ...
    const handleChange = (e) => {
        ...
        setInputValue(val);
        // 如果使用者選了 datalist 中的選項，直接轉換為標籤
        // 加入 setTimeout(0) 讓 React 狀態先更新，再清空輸入框，避免原生 datalist 行為衝突
...
// --- 由文本解析匯入之完整資料庫 (共159筆，source 已轉陣列) ---
const INITIAL_DATA = [
  { id: '1', district: '中壢區', name: '中壢國小', level: '國小', status: '施工中', budgetSource1: '中央補助', budgetSource2: '國土署', budgetAmount: 2390, startDate: '2024/12/27', endDate: '2026/03/31', agency: '都發局', source: ['局處會勘'], features: { pole: false, shelter: false, light: false, pickup: false }, scheduleMonth: '', isExcluded: false, isNotApproved: false },
  { id: '2', district: '中壢區', name: '林森國小', level: '國小', status: '規劃中', budgetSource1: '市府預算', budgetSource2: '公務預算', budgetAmount: 1890, startDate: '2026/04/01', endDate: '2026/07/01', agency: '養工處', source: ['彭俊豪(議員)'], features: { pole: false, shelter: false, light: false, pickup: false }, scheduleMonth: '', isExcluded: false, isNotApproved: false },
  { id: '3', district: '中壢區', name: '龍興國中', level: '國中', status: '規劃中', budgetSource1: '中央補助', budgetSource2: '國土署', budgetAmount: 1000, startDate: '', endDate: '', agency: '區公所', source: [], features: { pole: false, shelter: false, light: false, pickup: false }, scheduleMonth: '', isExcluded: false, isNotApproved: false },
  { id: '4', district: '中壢區', name: '興國國小', level: '國小', status: '規劃中', budgetSource1: '市府預算', budgetSource2: '其他基金', budgetAmount: 300, startDate: '2026/06/01', endDate: '', agency: '區公所', source: [], features: { pole: false, shelter: false, light: false, pickup: false }, scheduleMonth: '', isExcluded: false, isNotApproved: false },
  { id: '5', district: '中壢區', name: '興仁國小', level: '國小', status: '規劃中', budgetSource1: '市府預算', budgetSource2: '其他基金', budgetAmount: 300, startDate: '2026/06/01', endDate: '', agency: '區公所', source: [], features: { pole: false, shelter: false, light: false, pickup: false }, scheduleMonth: '', isExcluded: false, isNotApproved: false },
  { id: '6', district: '中壢區', name: '中央大學', level: '大學', status: '已完工', budgetSource1: '中央補助', budgetSource2: '國土署', budgetAmount: 3500, startDate: '2023/10/16', endDate: '2024/07/05', agency: '區公所', source: [], features: { pole: false, shelter: false, light: false, pickup: false }, scheduleMonth: '', isExcluded: false, isNotApproved: false },
  { id: '7', district: '中壢區', name: '中平國小1期', level: '國小', status: '已完工', budgetSource1: '市府預算', budgetSource2: '統籌分配', budgetAmount: 310, startDate: '2023/10/30', endDate: '2024/02/25', agency: '養工處', source: [], features: { pole: false, shelter: false, light: false, pickup: false }, scheduleMonth: '', isExcluded: false, isNotApproved: false },
  { id: '8', district: '中壢區', name: '中平國小2期', level: '國小', status: '已完工', budgetSource1: '市府預算', budgetSource2: '公務預算', budgetAmount: 250, startDate: '2025/07/10', endDate: '2025/12/10', agency: '養工處', source: [], features: { pole: false, shelter: false, light: false, pickup: false }, scheduleMonth: '', isExcluded: false, isNotApproved: false },
  { id: '9', district: '中壢區', name: '新街國小', level: '國小', status: '已完工', budgetSource1: '市府預算', budgetSource2: '其他基金', budgetAmount: 249, startDate: '2023/04/17', endDate: '2023/06/02', agency: '養工處', source: [], features: { pole: false, shelter: false, light: false, pickup: false }, scheduleMonth: '', isExcluded: false, isNotApproved: false },
  { id: '10', district: '中壢區', name: '內壢高中', level: '高中', status: '已完工', budgetSource1: '市府預算', budgetSource2: '其他基金', budgetAmount: 173.5, startDate: '2024/11/05', endDate: '2025/01/10', agency: '區公所', source: [], features: { pole: false, shelter: false, light: false, pickup: false }, scheduleMonth: '', isExcluded: false, isNotApproved: false },
  { id: '11', district: '中壢區', name: '新明國中', level: '國中', status: '已完工', budgetSource1: '中央補助', budgetSource2: '國土署', budgetAmount: 323.3, startDate: '2024/10/29', endDate: '2024/12/25', agency: '養工處', source: [], features: { pole: false, shelter: false, light: false, pickup: false }, scheduleMonth: '', isExcluded: false, isNotApproved: false },
  { id: '12', district: '中壢區', name: '過嶺國中', level: '國中', status: '已完工', budgetSource1: '市府預算', budgetSource2: '統籌分配', budgetAmount: 140, startDate: '2024/12/15', endDate: '2025/02/28', agency: '養工處', source: [], features: { pole: false, shelter: false, light: false, pickup: false }, scheduleMonth: '', isExcluded: false, isNotApproved: false },
  { id: '13', district: '中壢區', name: '內壢國小', level: '國小', status: '已完工', budgetSource1: '中央補助', budgetSource2: '國土署', budgetAmount: 2623, startDate: '2025/01/21', endDate: '2026/02/05', agency: '區公所', source: [], features: { pole: false, shelter: false, light: false, pickup: false }, scheduleMonth: '', isExcluded: false, isNotApproved: false },
  { id: '14', district: '八德區', name: '大成國小', level: '國小', status: '暫緩', budgetSource1: '市府預算', budgetSource2: '公務預算', budgetAmount: 0, startDate: '', endDate: '', agency: '養工處', source: [], features: { pole: false, shelter: false, light: false, pickup: false }, scheduleMonth: '', isExcluded: false, isNotApproved: false },
  { id: '15', district: '八德區', name: '八德國中2期', level: '國中', status: '暫緩', budgetSource1: '市府預算', budgetSource2: '公務預算', budgetAmount: 2500, startDate: '', endDate: '', agency: '養工處', source: [], features: { pole: false, shelter: false, light: false, pickup: false }, scheduleMonth: '', isExcluded: false, isNotApproved: false },
  { id: '16', district: '八德區', name: '大勇國小', level: '國小', status: '已完工', budgetSource1: '市府預算', budgetSource2: '統籌分配', budgetAmount: 133, startDate: '2024/05/01', endDate: '2024/05/21', agency: '養工處', source: [], features: { pole: false, shelter: false, light: false, pickup: false }, scheduleMonth: '', isExcluded: false, isNotApproved: false },
  { id: '17', district: '八德區', name: '大忠國小', level: '國小', status: '已完工', budgetSource1: '市府預算', budgetSource2: '統籌分配', budgetAmount: 65, startDate: '2023/11/30', endDate: '2023/12/10', agency: '養工處', source: [], features: { pole: false, shelter: false, light: false, pickup: false }, scheduleMonth: '', isExcluded: false, isNotApproved: false },
  { id: '18', district: '八德區', name: '廣興國小1期', level: '國小', status: '已完工', budgetSource1: '市府預算', budgetSource2: '其他基金', budgetAmount: 61, startDate: '2023/12/01', endDate: '2023/12/15', agency: '區公所', source: [], features: { pole: false, shelter: false, light: false, pickup: false }, scheduleMonth: '', isExcluded: false, isNotApproved: false },
  { id: '19', district: '八德區', name: '廣興國小2期', level: '國小', status: '已完工', budgetSource1: '市府預算', budgetSource2: '公務預算', budgetAmount: 400, startDate: '2025/04/01', endDate: '2025/05/15', agency: '養工處', source: [], features: { pole: false, shelter: false, light: false, pickup: false }, scheduleMonth: '', isExcluded: false, isNotApproved: false },
  { id: '20', district: '八德區', name: '大成國中', level: '國中', status: '已完工', budgetSource1: '市府預算', budgetSource2: '統籌分配', budgetAmount: 420, startDate: '2023/08/15', endDate: '2023/10/31', agency: '教育局', source: [], features: { pole: false, shelter: false, light: false, pickup: false }, scheduleMonth: '', isExcluded: false, isNotApproved: false },
  { id: '21', district: '八德區', name: '茄苳國小', level: '國小', status: '已完工', budgetSource1: '市府預算', budgetSource2: '統籌分配', budgetAmount: 643, startDate: '2024/05/04', endDate: '2024/08/10', agency: '養工處', source: [], features: { pole: false, shelter: false, light: false, pickup: false }, scheduleMonth: '', isExcluded: false, isNotApproved: false },
  { id: '22', district: '八德區', name: '八德國小', level: '國小', status: '已完工', budgetSource1: '中央補助', budgetSource2: '國土署', budgetAmount: 655, startDate: '2024/07/22', endDate: '2024/12/27', agency: '養工處', source: [], features: { pole: false, shelter: false, light: false, pickup: false }, scheduleMonth: '', isExcluded: false, isNotApproved: false },
  { id: '23', district: '八德區', name: '八德國中', level: '國中', status: '已完工', budgetSource1: '中央補助', budgetSource2: '國土署', budgetAmount: 655, startDate: '2024/07/22', endDate: '2024/12/27', agency: '養工處', source: [], features: { pole: false, shelter: false, light: false, pickup: false }, scheduleMonth: '', isExcluded: false, isNotApproved: false },
  { id: '24', district: '八德區', name: '大安國小', level: '國小', status: '已完工', budgetSource1: '中央補助', budgetSource2: '公路局', budgetAmount: 833, startDate: '2024/09/17', endDate: '2025/02/28', agency: '養工處', source: [], features: { pole: false, shelter: false, light: false, pickup: false }, scheduleMonth: '', isExcluded: false, isNotApproved: false },
  { id: '25', district: '八德區', name: '瑞豐國小', level: '國小', status: '已完工', budgetSource1: '中央補助', budgetSource2: '公路局', budgetAmount: 833, startDate: '2024/09/17', endDate: '2025/02/28', agency: '養工處', source: [], features: { pole: false, shelter: false, light: false, pickup: false }, scheduleMonth: '', isExcluded: false, isNotApproved: false },
  { id: '26', district: '平鎮區', name: '北勢國小', level: '國小', status: '規劃中', budgetSource1: '中央補助', budgetSource2: '公路局', budgetAmount: 970, startDate: '', endDate: '', agency: '區公所', source: [], features: { pole: false, shelter: false, light: false, pickup: false }, scheduleMonth: '', isExcluded: false, isNotApproved: false },
  { id: '27', district: '平鎮區', name: '忠貞國小', level: '國小', status: '規劃中', budgetSource1: '市府預算', budgetSource2: '公務預算', budgetAmount: 250, startDate: '', endDate: '', agency: '養工處', source: [], features: { pole: false, shelter: false, light: false, pickup: false }, scheduleMonth: '', isExcluded: false, isNotApproved: false },
  { id: '28', district: '平鎮區', name: '平南國中', level: '國中', status: '規劃中', budgetSource1: '市府預算', budgetSource2: '公務預算', budgetAmount: 250, startDate: '2026/06/01', endDate: '', agency: '養工處', source: [], features: { pole: false, shelter: false, light: false, pickup: false }, scheduleMonth: '', isExcluded: false, isNotApproved: false },
  { id: '29', district: '平鎮區', name: '東安國小', level: '國小', status: '已完工', budgetSource1: '中央補助', budgetSource2: '國土署', budgetAmount: 959, startDate: '2024/07/15', endDate: '2024/10/12', agency: '區公所', source: [], features: { pole: false, shelter: false, light: false, pickup: false }, scheduleMonth: '', isExcluded: false, isNotApproved: false },
  { id: '30', district: '平鎮區', name: '南勢國小', level: '國小', status: '已完工', budgetSource1: '市府預算', budgetSource2: '統籌分配', budgetAmount: 1050, startDate: '2024/01/15', endDate: '2024/05/15', agency: '養工處', source: [], features: { pole: false, shelter: false, light: false, pickup: false }, scheduleMonth: '', isExcluded: false, isNotApproved: false },
  { id: '31', district: '平鎮區', name: '山豐國小1期', level: '國小', status: '已完工', budgetSource1: '市府預算', budgetSource2: '統籌分配', budgetAmount: 50, startDate: '2023/12/01', endDate: '2024/04/21', agency: '養工處', source: [], features: { pole: false, shelter: false, light: false, pickup: false }, scheduleMonth: '', isExcluded: false, isNotApproved: false },
  { id: '32', district: '平鎮區', name: '山豐國小2期', level: '國小', status: '已完工', budgetSource1: '市府預算', budgetSource2: '統籌分配', budgetAmount: 150, startDate: '2024/09/15', endDate: '2024/10/07', agency: '養工處', source: [], features: { pole: false, shelter: false, light: false, pickup: false }, scheduleMonth: '', isExcluded: false, isNotApproved: false },
  { id: '33', district: '平鎮區', name: '新勢國小', level: '國小', status: '已完工', budgetSource1: '中央補助', budgetSource2: '國土署', budgetAmount: 250, startDate: '2024/08/16', endDate: '2024/09/23', agency: '區公所', source: [], features: { pole: false, shelter: false, light: false, pickup: false }, scheduleMonth: '', isExcluded: false, isNotApproved: false },
  { id: '34', district: '平鎮區', name: '祥安國小', level: '國小', status: '已完工', budgetSource1: '市府預算', budgetSource2: '統籌分配', budgetAmount: 100, startDate: '2024/07/25', endDate: '2024/08/30', agency: '養工處', source: [], features: { pole: false, shelter: false, light: false, pickup: false }, scheduleMonth: '', isExcluded: false, isNotApproved: false },
  { id: '35', district: '平鎮區', name: '復旦國小', level: '國小', status: '已完工', budgetSource1: '市府預算', budgetSource2: '統籌分配', budgetAmount: 284, startDate: '2024/08/02', endDate: '2024/08/30', agency: '養工處', source: [], features: { pole: false, shelter: false, light: false, pickup: false }, scheduleMonth: '', isExcluded: false, isNotApproved: false },
  { id: '36', district: '平鎮區', name: '文化國小', level: '國小', status: '已完工', budgetSource1: '市府預算', budgetSource2: '統籌分配', budgetAmount: 43, startDate: '2024/04/03', endDate: '2024/04/12', agency: '養工處', source: [], features: { pole: false, shelter: false, light: false, pickup: false }, scheduleMonth: '', isExcluded: false, isNotApproved: false },
  { id: '37', district: '平鎮區', name: '義興國小', level: '國小', status: '已完工', budgetSource1: '市府預算', budgetSource2: '統籌分配', budgetAmount: 44, startDate: '2024/03/16', endDate: '2024/04/29', agency: '養工處', source: [], features: { pole: false, shelter: false, light: false, pickup: false }, scheduleMonth: '', isExcluded: false, isNotApproved: false },
  { id: '38', district: '平鎮區', name: '東安國中', level: '國中', status: '已完工', budgetSource1: '中央補助', budgetSource2: '國土署', budgetAmount: 959, startDate: '2024/07/05', endDate: '2024/09/07', agency: '區公所', source: [], features: { pole: false, shelter: false, light: false, pickup: false }, scheduleMonth: '', isExcluded: false, isNotApproved: false },
  { id: '39', district: '平鎮區', name: '平興國小', level: '國小', status: '已完工', budgetSource1: '市府預算', budgetSource2: '其他基金', budgetAmount: 875, startDate: '2024/07/01', endDate: '2024/09/20', agency: '區公所', source: [], features: { pole: false, shelter: false, light: false, pickup: false }, scheduleMonth: '', isExcluded: false, isNotApproved: false },
  { id: '40', district: '平鎮區', name: '平鎮高中', level: '高中', status: '已完工', budgetSource1: '中央補助', budgetSource2: '國土署', budgetAmount: 1000, startDate: '2024/08/09', endDate: '2024/11/01', agency: '養工處', source: [], features: { pole: false, shelter: false, light: false, pickup: false }, scheduleMonth: '', isExcluded: false, isNotApproved: false },
  { id: '41', district: '平鎮區', name: '新榮國小', level: '國小', status: '已完工', budgetSource1: '市府預算', budgetSource2: '統籌分配', budgetAmount: 54, startDate: '2024/07/30', endDate: '2024/08/03', agency: '養工處', source: [], features: { pole: false, shelter: false, light: false, pickup: false }, scheduleMonth: '', isExcluded: false, isNotApproved: false },
  { id: '42', district: '平鎮區', name: '義民公幼', level: '幼兒園', status: '已完工', budgetSource1: '市府預算', budgetSource2: '其他基金', budgetAmount: 350, startDate: '2024/10/14', endDate: '2025/01/09', agency: '養工處', source: [], features: { pole: false, shelter: false, light: false, pickup: false }, scheduleMonth: '', isExcluded: false, isNotApproved: false },
  { id: '43', district: '平鎮區', name: '東勢國小', level: '國小', status: '已完工', budgetSource1: '市府預算', budgetSource2: '其他基金', budgetAmount: 200, startDate: '2025/02/06', endDate: '2025/03/31', agency: '養工處', source: [], features: { pole: false, shelter: false, light: false, pickup: false }, scheduleMonth: '', isExcluded: false, isNotApproved: false },
  { id: '44', district: '平鎮區', name: '平鎮國中', level: '國中', status: '已完工', budgetSource1: '中央補助', budgetSource2: '國土署', budgetAmount: 1000, startDate: '2024/08/16', endDate: '2025/06/01', agency: '區公所', source: [], features: { pole: false, shelter: false, light: false, pickup: false }, scheduleMonth: '', isExcluded: false, isNotApproved: false },
  { id: '45', district: '平鎮區', name: '育達高中', level: '高中', status: '已完工', budgetSource1: '市府預算', budgetSource2: '公務預算', budgetAmount: 350, startDate: '2025/07/10', endDate: '2025/08/11', agency: '養工處', source: [], features: { pole: false, shelter: false, light: false, pickup: false }, scheduleMonth: '', isExcluded: false, isNotApproved: false },
  { id: '46', district: '平鎮區', name: '宋屋國小', level: '國小', status: '已完工', budgetSource1: '市府預算', budgetSource2: '公務預算', budgetAmount: 650, startDate: '2025/09/12', endDate: '2025/12/26', agency: '養工處', source: [], features: { pole: false, shelter: false, light: false, pickup: false }, scheduleMonth: '', isExcluded: false, isNotApproved: false },
  { id: '47', district: '大園區', name: '大園國際高中', level: '高中', status: '規劃中', budgetSource1: '市府預算', budgetSource2: '公務預算', budgetAmount: 200, startDate: '', endDate: '', agency: '養工處', source: [], features: { pole: false, shelter: false, light: false, pickup: false }, scheduleMonth: '', isExcluded: false, isNotApproved: false },
  { id: '48', district: '大園區', name: '溪海國小', level: '國小', status: '規劃中', budgetSource1: '市府預算', budgetSource2: '公務預算', budgetAmount: 300, startDate: '2026/06/01', endDate: '', agency: '交通局', source: [], features: { pole: false, shelter: false, light: false, pickup: false }, scheduleMonth: '', isExcluded: false, isNotApproved: false },
  { id: '49', district: '大園區', name: '大園國小', level: '國小', status: '已完工', budgetSource1: '中央補助', budgetSource2: '國土署', budgetAmount: 1470, startDate: '2023/08/18', endDate: '2023/11/22', agency: '區公所', source: [], features: { pole: false, shelter: false, light: false, pickup: false }, scheduleMonth: '', isExcluded: false, isNotApproved: false },
  { id: '50', district: '大園區', name: '五權國小', level: '國小', status: '已完工', budgetSource1: '市府預算', budgetSource2: '統籌分配', budgetAmount: 197, startDate: '2023/10/25', endDate: '2023/12/31', agency: '養工處', source: [], features: { pole: false, shelter: false, light: false, pickup: false }, scheduleMonth: '', isExcluded: false, isNotApproved: false },
  { id: '51', district: '大園區', name: '大園國中', level: '國中', status: '已完工', budgetSource1: '市府預算', budgetSource2: '統籌分配', budgetAmount: 4.5, startDate: '2024/03/15', endDate: '2024/04/05', agency: '養工處', source: [], features: { pole: false, shelter: false, light: false, pickup: false }, scheduleMonth: '', isExcluded: false, isNotApproved: false },
  { id: '52', district: '觀音區', name: '觀音國中', level: '國中', status: '規劃中', budgetSource1: '中央補助', budgetSource2: '國土署', budgetAmount: 2000, startDate: '', endDate: '', agency: '養工處', source: [], features: { pole: false, shelter: false, light: false, pickup: false }, scheduleMonth: '', isExcluded: false, isNotApproved: false },
  { id: '53', district: '觀音區', name: '草漯國小', level: '國小', status: '已完工', budgetSource1: '中央補助', budgetSource2: '國土署', budgetAmount: 749, startDate: '2024/03/04', endDate: '2024/10/30', agency: '養工處', source: [], features: { pole: false, shelter: false, light: false, pickup: false }, scheduleMonth: '', isExcluded: false, isNotApproved: false },
  { id: '54', district: '觀音區', name: '育仁國小', level: '國小', status: '已完工', budgetSource1: '市府預算', budgetSource2: '其他基金', budgetAmount: 106, startDate: '2023/11/10', endDate: '2024/03/12', agency: '區公所', source: [], features: { pole: false, shelter: false, light: false, pickup: false }, scheduleMonth: '', isExcluded: false, isNotApproved: false },
  { id: '55', district: '觀音區', name: '觀音國小', level: '國小', status: '已完工', budgetSource1: '市府預算', budgetSource2: '其他基金', budgetAmount: 1758, startDate: '2022/07/16', endDate: '2022/12/27', agency: '區公所', source: [], features: { pole: false, shelter: false, light: false, pickup: false }, scheduleMonth: '', isExcluded: false, isNotApproved: false },
  { id: '56', district: '觀音區', name: '新坡國小', level: '國小', status: '已完工', budgetSource1: '市府預算', budgetSource2: '統籌分配', budgetAmount: 250, startDate: '2024/07/17', endDate: '2024/12/30', agency: '養工處', source: [], features: { pole: false, shelter: false, light: false, pickup: false }, scheduleMonth: '', isExcluded: false, isNotApproved: false },
  { id: '57', district: '龜山區', name: '福源國小', level: '國小', status: '規劃中', budgetSource1: '市府預算', budgetSource2: '公務預算', budgetAmount: 300, startDate: '2026/06/01', endDate: '', agency: '養工處', source: [], features: { pole: false, shelter: false, light: false, pickup: false }, scheduleMonth: '', isExcluded: false, isNotApproved: false },
  { id: '58', district: '龜山區', name: '大埔國小', level: '國小', status: '規劃中', budgetSource1: '市府預算', budgetSource2: '公務預算', budgetAmount: 300, startDate: '2026/06/01', endDate: '', agency: '養工處', source: [], features: { pole: false, shelter: false, light: false, pickup: false }, scheduleMonth: '', isExcluded: false, isNotApproved: false },
  { id: '59', district: '龜山區', name: '文欣國小', level: '國小', status: '規劃中', budgetSource1: '市府預算', budgetSource2: '公務預算', budgetAmount: 300, startDate: '2026/06/01', endDate: '', agency: '養工處', source: [], features: { pole: false, shelter: false, light: false, pickup: false }, scheduleMonth: '', isExcluded: false, isNotApproved: false },
  { id: '60', district: '龜山區', name: '文青國中小', level: '國中', status: '規劃中', budgetSource1: '市府預算', budgetSource2: '其他基金', budgetAmount: 300, startDate: '2026/06/01', endDate: '', agency: '區公所', source: [], features: { pole: false, shelter: false, light: false, pickup: false }, scheduleMonth: '', isExcluded: false, isNotApproved: false },
  { id: '61', district: '龜山區', name: '大崗國小', level: '國小', status: '已完工', budgetSource1: '中央補助', budgetSource2: '國土署', budgetAmount: 2770, startDate: '2024/03/04', endDate: '2024/10/21', agency: '養工處', source: [], features: { pole: false, shelter: false, light: false, pickup: false }, scheduleMonth: '', isExcluded: false, isNotApproved: false },
  { id: '62', district: '龜山區', name: '大崗國中', level: '國中', status: '已完工', budgetSource1: '中央補助', budgetSource2: '國土署', budgetAmount: 8000, startDate: '2024/10/14', endDate: '2025/11/01', agency: '養工處', source: [], features: { pole: false, shelter: false, light: false, pickup: false }, scheduleMonth: '', isExcluded: false, isNotApproved: false },
  { id: '63', district: '龜山區', name: '大湖國小1期', level: '國小', status: '已完工', budgetSource1: '中央補助', budgetSource2: '國土署', budgetAmount: 1040, startDate: '2024/12/05', endDate: '2025/04/27', agency: '區公所', source: [], features: { pole: false, shelter: false, light: false, pickup: false }, scheduleMonth: '', isExcluded: false, isNotApproved: false },
  { id: '64', district: '龜山區', name: '大湖國小2期', level: '國小', status: '已完工', budgetSource1: '市府預算', budgetSource2: '統籌分配', budgetAmount: 250, startDate: '', endDate: '2024/12/19', agency: '養工處', source: [], features: { pole: false, shelter: false, light: false, pickup: false }, scheduleMonth: '', isExcluded: false, isNotApproved: false },
  { id: '65', district: '龜山區', name: '楓樹國小1期', level: '國小', status: '已完工', budgetSource1: '市府預算', budgetSource2: '其他基金', budgetAmount: 140, startDate: '2023/02/01', endDate: '2023/04/30', agency: '養工處', source: [], features: { pole: false, shelter: false, light: false, pickup: false }, scheduleMonth: '', isExcluded: false, isNotApproved: false },
  { id: '66', district: '龜山區', name: '楓樹國小2期', level: '國小', status: '已完工', budgetSource1: '市府預算', budgetSource2: '統籌分配', budgetAmount: 99, startDate: '2023/10/11', endDate: '2023/12/02', agency: '養工處', source: [], features: { pole: false, shelter: false, light: false, pickup: false }, scheduleMonth: '', isExcluded: false, isNotApproved: false },
  { id: '67', district: '龜山區', name: '光峰幼兒園', level: '幼兒園', status: '已完工', budgetSource1: '市府預算', budgetSource2: '其他基金', budgetAmount: 75, startDate: '2023/01/30', endDate: '2023/03/29', agency: '養工處', source: [], features: { pole: false, shelter: false, light: false, pickup: false }, scheduleMonth: '', isExcluded: false, isNotApproved: false },
  { id: '68', district: '龜山區', name: '龜山幼兒園', level: '幼兒園', status: '已完工', budgetSource1: '市府預算', budgetSource2: '統籌分配', budgetAmount: 2, startDate: '2023/05/27', endDate: '2023/05/27', agency: '養工處', source: [], features: { pole: false, shelter: false, light: false, pickup: false }, scheduleMonth: '', isExcluded: false, isNotApproved: false },
  { id: '69', district: '龜山區', name: '新路國小', level: '國小', status: '已完工', budgetSource1: '市府預算', budgetSource2: '統籌分配', budgetAmount: 91, startDate: '2024/01/22', endDate: '2024/04/20', agency: '養工處', source: [], features: { pole: false, shelter: false, light: false, pickup: false }, scheduleMonth: '', isExcluded: false, isNotApproved: false },
  { id: '70', district: '龜山區', name: '龜山國小', level: '國小', status: '已完工', budgetSource1: '中央補助', budgetSource2: '國土署', budgetAmount: 731, startDate: '2024/08/05', endDate: '2024/12/20', agency: '養工處', source: [], features: { pole: false, shelter: false, light: false, pickup: false }, scheduleMonth: '', isExcluded: false, isNotApproved: false },
  { id: '71', district: '龜山區', name: '壽山高中', level: '高中', status: '已完工', budgetSource1: '中央補助', budgetSource2: '國土署', budgetAmount: 732, startDate: '2024/08/05', endDate: '2024/12/20', agency: '養工處', source: [], features: { pole: false, shelter: false, light: false, pickup: false }, scheduleMonth: '', isExcluded: false, isNotApproved: false },
  { id: '72', district: '龜山區', name: '山頂國小', level: '國小', status: '已完工', budgetSource1: '中央補助', budgetSource2: '國土署', budgetAmount: 600, startDate: '2024/09/10', endDate: '2024/12/27', agency: '區公所', source: [], features: { pole: false, shelter: false, light: false, pickup: false }, scheduleMonth: '', isExcluded: false, isNotApproved: false },
  { id: '73', district: '龜山區', name: '南美國小', level: '國小', status: '已完工', budgetSource1: '中央補助', budgetSource2: '國土署', budgetAmount: 989, startDate: '2024/08/13', endDate: '2024/12/26', agency: '養工處', source: [], features: { pole: false, shelter: false, light: false, pickup: false }, scheduleMonth: '', isExcluded: false, isNotApproved: false },
  { id: '74', district: '龜山區', name: '樂善國小', level: '國小', status: '已完工', budgetSource1: '中央補助', budgetSource2: '國土署', budgetAmount: 989, startDate: '2024/08/13', endDate: '2024/12/26', agency: '養工處', source: [], features: { pole: false, shelter: false, light: false, pickup: false }, scheduleMonth: '', isExcluded: false, isNotApproved: false },
  { id: '75', district: '龜山區', name: '幸福國小', level: '國小', status: '已完工', budgetSource1: '市府預算', budgetSource2: '其他基金', budgetAmount: 220, startDate: '2023/06/13', endDate: '2023/08/22', agency: '區公所', source: [], features: { pole: false, shelter: false, light: false, pickup: false }, scheduleMonth: '', isExcluded: false, isNotApproved: false },
  { id: '76', district: '龜山區', name: '自強國小1期', level: '國小', status: '已完工', budgetSource1: '市府預算', budgetSource2: '統籌分配', budgetAmount: 250, startDate: '2024/08/28', endDate: '2024/10/14', agency: '養工處', source: [], features: { pole: false, shelter: false, light: false, pickup: false }, scheduleMonth: '', isExcluded: false, isNotApproved: false },
  { id: '77', district: '龜山區', name: '自強國小2期', level: '國小', status: '已完工', budgetSource1: '市府預算', budgetSource2: '公務預算', budgetAmount: 450, startDate: '2025/08/29', endDate: '2025/10/27', agency: '養工處', source: [], features: { pole: false, shelter: false, light: false, pickup: false }, scheduleMonth: '', isExcluded: false, isNotApproved: false },
  { id: '78', district: '龜山區', name: '龜山國中', level: '國中', status: '已完工', budgetSource1: '中央補助', budgetSource2: '國土署', budgetAmount: 280, startDate: '2023/11/20', endDate: '2024/08/01', agency: '養工處', source: [], features: { pole: false, shelter: false, light: false, pickup: false }, scheduleMonth: '', isExcluded: false, isNotApproved: false },
  { id: '79', district: '龜山區', name: '文華國小', level: '國小', status: '已完工', budgetSource1: '中央補助', budgetSource2: '國土署', budgetAmount: 1300, startDate: '2025/08/25', endDate: '2026/01/05', agency: '養工處', source: [], features: { pole: false, shelter: false, light: false, pickup: false }, scheduleMonth: '', isExcluded: false, isNotApproved: false },
  { id: '80', district: '蘆竹區', name: '南崁高中', level: '高中', status: '規劃中', budgetSource1: '中央補助', budgetSource2: '國土署', budgetAmount: 2050, startDate: '2026/03/26', endDate: '2027/01/15', agency: '航工處', source: [], features: { pole: false, shelter: false, light: false, pickup: false }, scheduleMonth: '', isExcluded: false, isNotApproved: false },
  { id: '81', district: '蘆竹區', name: '南崁國中', level: '國中', status: '規劃中', budgetSource1: '中央補助', budgetSource2: '國土署', budgetAmount: 2050, startDate: '2026/03/26', endDate: '2027/01/15', agency: '航工處', source: [], features: { pole: false, shelter: false, light: false, pickup: false }, scheduleMonth: '', isExcluded: false, isNotApproved: false },
  { id: '82', district: '蘆竹區', name: '外社國小', level: '國小', status: '規劃中', budgetSource1: '市府預算', budgetSource2: '公務預算', budgetAmount: 578, startDate: '2026/06/01', endDate: '', agency: '養工處', source: [], features: { pole: false, shelter: false, light: false, pickup: false }, scheduleMonth: '', isExcluded: false, isNotApproved: false },
  { id: '83', district: '蘆竹區', name: '新興國小', level: '國小', status: '暫緩', budgetSource1: '市府預算', budgetSource2: '公務預算', budgetAmount: 0, startDate: '', endDate: '', agency: '區公所', source: [], features: { pole: false, shelter: false, light: false, pickup: false }, scheduleMonth: '', isExcluded: false, isNotApproved: false },
  { id: '84', district: '蘆竹區', name: '錦興國小', level: '國小', status: '已完工', budgetSource1: '中央補助', budgetSource2: '國土署', budgetAmount: 1400, startDate: '2024/07/22', endDate: '2024/12/10', agency: '區公所', source: [], features: { pole: false, shelter: false, light: false, pickup: false }, scheduleMonth: '', isExcluded: false, isNotApproved: false },
  { id: '85', district: '蘆竹區', name: '山腳國小1期', level: '國小', status: '已完工', budgetSource1: '市府預算', budgetSource2: '其他基金', budgetAmount: 16, startDate: '2023/08/28', endDate: '2023/08/28', agency: '養工處', source: [], features: { pole: false, shelter: false, light: false, pickup: false }, scheduleMonth: '', isExcluded: false, isNotApproved: false },
  { id: '86', district: '蘆竹區', name: '山腳國小2期', level: '國小', status: '已完工', budgetSource1: '市府預算', budgetSource2: '其他基金', budgetAmount: 130, startDate: '2024/02/01', endDate: '2024/04/15', agency: '區公所', source: [], features: { pole: false, shelter: false, light: false, pickup: false }, scheduleMonth: '', isExcluded: false, isNotApproved: false },
  { id: '87', district: '蘆竹區', name: '大竹國小1期', level: '國小', status: '已完工', budgetSource1: '中央補助', budgetSource2: '國土署', budgetAmount: 513, startDate: '2024/07/29', endDate: '2024/10/14', agency: '航空處', source: [], features: { pole: false, shelter: false, light: false, pickup: false }, scheduleMonth: '', isExcluded: false, isNotApproved: false },
  { id: '88', district: '蘆竹區', name: '大竹國中', level: '國中', status: '已完工', budgetSource1: '中央補助', budgetSource2: '國土署', budgetAmount: 514, startDate: '2024/07/29', endDate: '2024/10/14', agency: '航空處', source: [], features: { pole: false, shelter: false, light: false, pickup: false }, scheduleMonth: '', isExcluded: false, isNotApproved: false },
  { id: '89', district: '蘆竹區', name: '大竹國小2期', level: '國小', status: '已完工', budgetSource1: '市府預算', budgetSource2: '公務預算', budgetAmount: 100, startDate: '2025/11/01', endDate: '2025/12/26', agency: '養工處', source: [], features: { pole: false, shelter: false, light: false, pickup: false }, scheduleMonth: '', isExcluded: false, isNotApproved: false },
  { id: '90', district: '蘆竹區', name: '蘆竹國小', level: '國小', status: '已完工', budgetSource1: '市府預算', budgetSource2: '統籌分配', budgetAmount: 150, startDate: '2024/06/15', endDate: '2024/07/12', agency: '養工處', source: [], features: { pole: false, shelter: false, light: false, pickup: false }, scheduleMonth: '', isExcluded: false, isNotApproved: false },
  { id: '91', district: '蘆竹區', name: '大華國小', level: '國小', status: '已完工', budgetSource1: '市府預算', budgetSource2: '其他基金', budgetAmount: 150, startDate: '2024/06/12', endDate: '2024/07/05', agency: '養工處', source: [], features: { pole: false, shelter: false, light: false, pickup: false }, scheduleMonth: '', isExcluded: false, isNotApproved: false },
  { id: '92', district: '蘆竹區', name: '山腳國中', level: '國中', status: '已完工', budgetSource1: '市府預算', budgetSource2: '公務預算', budgetAmount: 300, startDate: '2025/04/07', endDate: '2025/06/30', agency: '養工處', source: [], features: { pole: false, shelter: false, light: false, pickup: false }, scheduleMonth: '', isExcluded: false, isNotApproved: false },
  { id: '93', district: '大溪區', name: '中興國小', level: '國小', status: '施工中', budgetSource1: '中央補助', budgetSource2: '公路局', budgetAmount: 981, startDate: '2025/09/02', endDate: '2026/03/31', agency: '養工處', source: [], features: { pole: false, shelter: false, light: false, pickup: false }, scheduleMonth: '', isExcluded: false, isNotApproved: false },
  { id: '94', district: '大溪區', name: '大溪國中', level: '國中', status: '暫緩', budgetSource1: '中央補助', budgetSource2: '國土署', budgetAmount: 327, startDate: '', endDate: '', agency: '區公所', source: [], features: { pole: false, shelter: false, light: false, pickup: false }, scheduleMonth: '', isExcluded: false, isNotApproved: false },
  { id: '95', district: '大溪區', name: '仁和國中', level: '國中', status: '施工中', budgetSource1: '中央補助', budgetSource2: '國土署', budgetAmount: 1423, startDate: '2026/01/23', endDate: '2026/12/30', agency: '區公所', source: [], features: { pole: false, shelter: false, light: false, pickup: false }, scheduleMonth: '', isExcluded: false, isNotApproved: false },
  { id: '96', district: '大溪區', name: '仁善國小', level: '國小', status: '施工中', budgetSource1: '中央補助', budgetSource2: '國土署', budgetAmount: 500, startDate: '2025/05/13', endDate: '2026/04/21', agency: '養工處', source: [], features: { pole: false, shelter: false, light: false, pickup: false }, scheduleMonth: '', isExcluded: false, isNotApproved: false },
  { id: '97', district: '大溪區', name: '員樹林國小', level: '國小', status: '規劃中', budgetSource1: '市府預算', budgetSource2: '公務預算', budgetAmount: 300, startDate: '2026/06/01', endDate: '', agency: '區公所', source: [], features: { pole: false, shelter: false, light: false, pickup: false }, scheduleMonth: '', isExcluded: false, isNotApproved: false },
  { id: '98', district: '大溪區', name: '僑愛國小', level: '國小', status: '規劃中', budgetSource1: '市府預算', budgetSource2: '公務預算', budgetAmount: 300, startDate: '2026/06/01', endDate: '', agency: '區公所', source: [], features: { pole: false, shelter: false, light: false, pickup: false }, scheduleMonth: '', isExcluded: false, isNotApproved: false },
  { id: '99', district: '大溪區', name: '田心國小', level: '國小', status: '規劃中', budgetSource1: '市府預算', budgetSource2: '公務預算', budgetAmount: 300, startDate: '2026/06/01', endDate: '', agency: '區公所', source: [], features: { pole: false, shelter: false, light: false, pickup: false }, scheduleMonth: '', isExcluded: false, isNotApproved: false },
  { id: '100', district: '大溪區', name: '福安國小', level: '國小', status: '規劃中', budgetSource1: '市府預算', budgetSource2: '公務預算', budgetAmount: 300, startDate: '2026/06/01', endDate: '', agency: '區公所', source: [], features: { pole: false, shelter: false, light: false, pickup: false }, scheduleMonth: '', isExcluded: false, isNotApproved: false },
  { id: '101', district: '大溪區', name: '永福國小', level: '國小', status: '規劃中', budgetSource1: '市府預算', budgetSource2: '公務預算', budgetAmount: 300, startDate: '2026/06/01', endDate: '', agency: '區公所', source: [], features: { pole: false, shelter: false, light: false, pickup: false }, scheduleMonth: '', isExcluded: false, isNotApproved: false },
  { id: '102', district: '大溪區', name: '大溪國小', level: '國小', status: '已完工', budgetSource1: '中央補助', budgetSource2: '國土署', budgetAmount: 1536, startDate: '2023/07/31', endDate: '2023/11/01', agency: '區公所', source: [], features: { pole: false, shelter: false, light: false, pickup: false }, scheduleMonth: '', isExcluded: false, isNotApproved: false },
  { id: '103', district: '大溪區', name: '南興國小', level: '國小', status: '已完工', budgetSource1: '市府預算', budgetSource2: '其他基金', budgetAmount: 91, startDate: '2023/01/03', endDate: '2023/03/04', agency: '養工處', source: [], features: { pole: false, shelter: false, light: false, pickup: false }, scheduleMonth: '', isExcluded: false, isNotApproved: false },
  { id: '104', district: '大溪區', name: '內柵國小', level: '國小', status: '已完工', budgetSource1: '市府預算', budgetSource2: '公務預算', budgetAmount: 300, startDate: '', endDate: '2025/09/01', agency: '區公所', source: [], features: { pole: false, shelter: false, light: false, pickup: false }, scheduleMonth: '', isExcluded: false, isNotApproved: false },
  { id: '105', district: '大溪區', name: '瑞祥國小', level: '國小', status: '已完工', budgetSource1: '市府預算', budgetSource2: '公務預算', budgetAmount: 300, startDate: '', endDate: '2025/08/28', agency: '區公所', source: [], features: { pole: false, shelter: false, light: false, pickup: false }, scheduleMonth: '', isExcluded: false, isNotApproved: false },
  { id: '106', district: '新屋區', name: '埔頂國小', level: '國小', status: '規劃中', budgetSource1: '市府預算', budgetSource2: '其他基金', budgetAmount: 500, startDate: '2026/06/01', endDate: '2027/01/01', agency: '用地科', source: [], features: { pole: false, shelter: false, light: false, pickup: false }, scheduleMonth: '', isExcluded: false, isNotApproved: false },
  { id: '107', district: '新屋區', name: '大坡國中', level: '國中', status: '已完工', budgetSource1: '中央補助', budgetSource2: '公路局', budgetAmount: 250, startDate: '2023/11/28', endDate: '2024/05/09', agency: '養工處', source: [], features: { pole: false, shelter: false, light: false, pickup: false }, scheduleMonth: '', isExcluded: false, isNotApproved: false },
  { id: '108', district: '新屋區', name: '北湖國小', level: '國小', status: '已完工', budgetSource1: '中央補助', budgetSource2: '公路局', budgetAmount: 250, startDate: '2024/05/15', endDate: '2024/07/01', agency: '養工處', source: [], features: { pole: false, shelter: false, light: false, pickup: false }, scheduleMonth: '', isExcluded: false, isNotApproved: false },
  { id: '109', district: '新屋區', name: '永安國中', level: '國中', status: '已完工', budgetSource1: '中央補助', budgetSource2: '公路局', budgetAmount: 320, startDate: '2024/07/15', endDate: '2025/04/15', agency: '養工處', source: [], features: { pole: false, shelter: false, light: false, pickup: false }, scheduleMonth: '', isExcluded: false, isNotApproved: false },
  { id: '110', district: '新屋區', name: '永安國小', level: '國小', status: '已完工', budgetSource1: '中央補助', budgetSource2: '公路局', budgetAmount: 470, startDate: '2024/07/15', endDate: '2025/04/15', agency: '養工處', source: [], features: { pole: false, shelter: false, light: false, pickup: false }, scheduleMonth: '', isExcluded: false, isNotApproved: false },
  { id: '111', district: '新屋區', name: '東明國小', level: '國小', status: '已完工', budgetSource1: '中央補助', budgetSource2: '公路局', budgetAmount: 920, startDate: '2024/07/15', endDate: '2025/06/04', agency: '養工處', source: [], features: { pole: false, shelter: false, light: false, pickup: false }, scheduleMonth: '', isExcluded: false, isNotApproved: false },
  { id: '112', district: '桃園區', name: '中山國小', level: '國小', status: '暫緩', budgetSource1: '市府預算', budgetSource2: '公務預算', budgetAmount: 0, startDate: '', endDate: '', agency: '養工處', source: [], features: { pole: false, shelter: false, light: false, pickup: false }, scheduleMonth: '', isExcluded: false, isNotApproved: false },
  { id: '113', district: '桃園區', name: '會稽國小', level: '國小', status: '規劃中', budgetSource1: '市府預算', budgetSource2: '道路基金', budgetAmount: 280, startDate: '', endDate: '', agency: '區公所', source: [], features: { pole: false, shelter: false, light: false, pickup: false }, scheduleMonth: '', isExcluded: false, isNotApproved: false },
  { id: '114', district: '桃園區', name: '莊敬國小', level: '國小', status: '暫緩', budgetSource1: '市府預算', budgetSource2: '公務預算', budgetAmount: 100, startDate: '', endDate: '', agency: '養工處', source: [], features: { pole: false, shelter: false, light: false, pickup: false }, scheduleMonth: '', isExcluded: false, isNotApproved: false },
  { id: '115', district: '桃園區', name: '桃園高中', level: '高中', status: '施工中', budgetSource1: '中央補助', budgetSource2: '國土署', budgetAmount: 5900, startDate: '2025/10/30', endDate: '2026/11/23', agency: '養工處', source: [], features: { pole: false, shelter: false, light: false, pickup: false }, scheduleMonth: '', isExcluded: false, isNotApproved: false },
  { id: '116', district: '桃園區', name: '北門國小', level: '國小', status: '規劃中', budgetSource1: '市府預算', budgetSource2: '公務預算', budgetAmount: 450, startDate: '', endDate: '', agency: '養工處', source: [], features: { pole: false, shelter: false, light: false, pickup: false }, scheduleMonth: '', isExcluded: false, isNotApproved: false },
  { id: '117', district: '桃園區', name: '中埔國小', level: '國小', status: '規劃中', budgetSource1: '市府預算', budgetSource2: '公務預算', budgetAmount: 0, startDate: '', endDate: '', agency: '養工處', source: [], features: { pole: false, shelter: false, light: false, pickup: false }, scheduleMonth: '', isExcluded: false, isNotApproved: false },
  { id: '118', district: '桃園區', name: '青溪國小', level: '國小', status: '規劃中', budgetSource1: '市府預算', budgetSource2: '公務預算', budgetAmount: 0, startDate: '', endDate: '', agency: '養工處', source: [], features: { pole: false, shelter: false, light: false, pickup: false }, scheduleMonth: '', isExcluded: false, isNotApproved: false },
  { id: '119', district: '桃園區', name: '永順國小', level: '國小', status: '規劃中', budgetSource1: '市府預算', budgetSource2: '公務預算', budgetAmount: 0, startDate: '', endDate: '', agency: '區公所', source: [], features: { pole: false, shelter: false, light: false, pickup: false }, scheduleMonth: '', isExcluded: false, isNotApproved: false },
  { id: '120', district: '桃園區', name: '文昌國中', level: '國中', status: '已完工', budgetSource1: '市府預算', budgetSource2: '統籌分配', budgetAmount: 320, startDate: '2023/11/15', endDate: '2024/03/15', agency: '養工處', source: [], features: { pole: false, shelter: false, light: false, pickup: false }, scheduleMonth: '', isExcluded: false, isNotApproved: false },
  { id: '121', district: '桃園區', name: '南門國小', level: '國小', status: '已完工', budgetSource1: '市府預算', budgetSource2: '其他基金', budgetAmount: 170, startDate: '2023/05/13', endDate: '2023/08/01', agency: '區公所', source: [], features: { pole: false, shelter: false, light: false, pickup: false }, scheduleMonth: '', isExcluded: false, isNotApproved: false },
  { id: '122', district: '桃園區', name: '桃園國小', level: '國小', status: '已完工', budgetSource1: '市府預算', budgetSource2: '統籌分配', budgetAmount: 200, startDate: '2024/07/15', endDate: '2024/08/28', agency: '養工處', source: [], features: { pole: false, shelter: false, light: false, pickup: false }, scheduleMonth: '', isExcluded: false, isNotApproved: false },
  { id: '123', district: '桃園區', name: '桃園國小1期', level: '國小', status: '已完工', budgetSource1: '中央補助', budgetSource2: '國土署', budgetAmount: 3570, startDate: '2024/12/27', endDate: '2025/09/01', agency: '都發局', source: [], features: { pole: false, shelter: false, light: false, pickup: false }, scheduleMonth: '', isExcluded: false, isNotApproved: false },
  { id: '124', district: '桃園區', name: '大業國小1期', level: '國小', status: '已完工', budgetSource1: '市府預算', budgetSource2: '統籌分配', budgetAmount: 471, startDate: '2023/12/26', endDate: '2024/05/15', agency: '養工處', source: [], features: { pole: false, shelter: false, light: false, pickup: false }, scheduleMonth: '', isExcluded: false, isNotApproved: false },
  { id: '125', district: '桃園區', name: '大業國小2期', level: '國小', status: '已完工', budgetSource1: '市府預算', budgetSource2: '統籌分配', budgetAmount: 0, startDate: '2025/01/06', endDate: '2025/02/26', agency: '養工處', source: [], features: { pole: false, shelter: false, light: false, pickup: false }, scheduleMonth: '', isExcluded: false, isNotApproved: false },
  { id: '126', district: '桃園區', name: '東門國小', level: '國小', status: '已完工', budgetSource1: '市府預算', budgetSource2: '其他基金', budgetAmount: 250, startDate: '2023/09/01', endDate: '2023/10/15', agency: '區公所', source: [], features: { pole: false, shelter: false, light: false, pickup: false }, scheduleMonth: '', isExcluded: false, isNotApproved: false },
  { id: '127', district: '桃園區', name: '建德國小1期', level: '國小', status: '已完工', budgetSource1: '市府預算', budgetSource2: '其他基金', budgetAmount: 490, startDate: '2023/07/01', endDate: '2023/08/29', agency: '養工處', source: [], features: { pole: false, shelter: false, light: false, pickup: false }, scheduleMonth: '', isExcluded: false, isNotApproved: false },
  { id: '128', district: '桃園區', name: '福豐國中', level: '國中', status: '已完工', budgetSource1: '市府預算', budgetSource2: '其他基金', budgetAmount: 490, startDate: '2023/07/01', endDate: '2023/08/29', agency: '養工處', source: [], features: { pole: false, shelter: false, light: false, pickup: false }, scheduleMonth: '', isExcluded: false, isNotApproved: false },
  { id: '129', district: '桃園區', name: '建德國小2期', level: '國小', status: '已完工', budgetSource1: '市府預算', budgetSource2: '公務預算', budgetAmount: 600, startDate: '2025/07/30', endDate: '2025/10/22', agency: '養工處', source: [], features: { pole: false, shelter: false, light: false, pickup: false }, scheduleMonth: '', isExcluded: false, isNotApproved: false },
  { id: '130', district: '桃園區', name: '中興國中', level: '國中', status: '已完工', budgetSource1: '中央補助', budgetSource2: '國土署', budgetAmount: 457, startDate: '2024/07/31', endDate: '2024/12/15', agency: '養工處', source: [], features: { pole: false, shelter: false, light: false, pickup: false }, scheduleMonth: '', isExcluded: false, isNotApproved: false },
  { id: '131', district: '桃園區', name: '文山國小1期', level: '國小', status: '已完工', budgetSource1: '中央補助', budgetSource2: '國土署', budgetAmount: 457, startDate: '2024/07/31', endDate: '2024/12/15', agency: '養工處', source: [], features: { pole: false, shelter: false, light: false, pickup: false }, scheduleMonth: '', isExcluded: false, isNotApproved: false },
  { id: '132', district: '桃園區', name: '文山國小2期', level: '國小', status: '已完工', budgetSource1: '市府預算', budgetSource2: '統籌分配', budgetAmount: 400, startDate: '2025/01/06', endDate: '2025/04/07', agency: '養工處', source: [], features: { pole: false, shelter: false, light: false, pickup: false }, scheduleMonth: '', isExcluded: false, isNotApproved: false },
  { id: '133', district: '桃園區', name: '龍山國小1期', level: '國小', status: '已完工', budgetSource1: '市府預算', budgetSource2: '統籌分配', budgetAmount: 23, startDate: '2023/12/12', endDate: '2023/12/18', agency: '養工處', source: [], features: { pole: false, shelter: false, light: false, pickup: false }, scheduleMonth: '', isExcluded: false, isNotApproved: false },
  { id: '134', district: '桃園區', name: '龍山國小2期', level: '國小', status: '已完工', budgetSource1: '市府預算', budgetSource2: '統籌分配', budgetAmount: 300, startDate: '2025/01/24', endDate: '2025/03/11', agency: '養工處', source: [], features: { pole: false, shelter: false, light: false, pickup: false }, scheduleMonth: '', isExcluded: false, isNotApproved: false },
  { id: '135', district: '桃園區', name: '同安國小', level: '國小', status: '已完工', budgetSource1: '市府預算', budgetSource2: '公務預算', budgetAmount: 600, startDate: '2025/07/08', endDate: '2025/09/22', agency: '養工處', source: [], features: { pole: false, shelter: false, light: false, pickup: false }, scheduleMonth: '', isExcluded: false, isNotApproved: false },
  { id: '136', district: '桃園區', name: '復興非營利幼兒園', level: '幼兒園', status: '已完工', budgetSource1: '市府預算', budgetSource2: '公務預算', budgetAmount: 100, startDate: '2025/08/25', endDate: '2025/09/17', agency: '養工處', source: [], features: { pole: false, shelter: false, light: false, pickup: false }, scheduleMonth: '', isExcluded: false, isNotApproved: false },
  { id: '137', district: '桃園區', name: '青溪國中', level: '國中', status: '已完工', budgetSource1: '市府預算', budgetSource2: '公務預算', budgetAmount: 0, startDate: '', endDate: '2025/10/31', agency: '區公所', source: [], features: { pole: false, shelter: false, light: false, pickup: false }, scheduleMonth: '', isExcluded: false, isNotApproved: false },
  { id: '138', district: '桃園區', name: '桃園市立桃園幼兒園', level: '幼兒園', status: '已完工', budgetSource1: '市府預算', budgetSource2: '公務預算', budgetAmount: 100, startDate: '2025/10/31', endDate: '2025/11/29', agency: '養工處', source: [], features: { pole: false, shelter: false, light: false, pickup: false }, scheduleMonth: '', isExcluded: false, isNotApproved: false },
  { id: '139', district: '楊梅區', name: '瑞埔國小2期', level: '國小', status: '規劃中', budgetSource1: '中央補助', budgetSource2: '國土署', budgetAmount: 1500, startDate: '', endDate: '', agency: '養工處', source: [], features: { pole: false, shelter: false, light: false, pickup: false }, scheduleMonth: '', isExcluded: false, isNotApproved: false },
  { id: '140', district: '楊梅區', name: '治平高中', level: '高中', status: '規劃中', budgetSource1: '中央補助', budgetSource2: '國土署', budgetAmount: 1500, startDate: '', endDate: '', agency: '養工處', source: [], features: { pole: false, shelter: false, light: false, pickup: false }, scheduleMonth: '', isExcluded: false, isNotApproved: false },
  { id: '141', district: '楊梅區', name: '楊梅國小', level: '國小', status: '規劃中', budgetSource1: '市府預算', budgetSource2: '公務預算', budgetAmount: 300, startDate: '', endDate: '', agency: '養工處', source: [], features: { pole: false, shelter: false, light: false, pickup: false }, scheduleMonth: '', isExcluded: false, isNotApproved: false },
  { id: '142', district: '楊梅區', name: '楊明國小', level: '國小', status: '規劃中', budgetSource1: '市府預算', budgetSource2: '其他基金', budgetAmount: 0, startDate: '', endDate: '', agency: '養工處', source: [], features: { pole: false, shelter: false, light: false, pickup: false }, scheduleMonth: '', isExcluded: false, isNotApproved: false },
  { id: '143', district: '楊梅區', name: '瑞埔國小1期', level: '國小', status: '已完工', budgetSource1: '市府預算', budgetSource2: '其他基金', budgetAmount: 200, startDate: '2024/01/31', endDate: '2024/03/11', agency: '養工處', source: [], features: { pole: false, shelter: false, light: false, pickup: false }, scheduleMonth: '', isExcluded: false, isNotApproved: false },
  { id: '144', district: '楊梅區', name: '瑞梅國小1期', level: '國小', status: '已完工', budgetSource1: '市府預算', budgetSource2: '其他基金', budgetAmount: 80, startDate: '2023/07/12', endDate: '2023/08/22', agency: '區公所', source: [], features: { pole: false, shelter: false, light: false, pickup: false }, scheduleMonth: '', isExcluded: false, isNotApproved: false },
  { id: '145', district: '楊梅區', name: '瑞梅國小2期', level: '國小', status: '已完工', budgetSource1: '市府預算', budgetSource2: '統籌分配', budgetAmount: 23, startDate: '2023/12/20', endDate: '2023/12/31', agency: '養工處', source: [], features: { pole: false, shelter: false, light: false, pickup: false }, scheduleMonth: '', isExcluded: false, isNotApproved: false },
  { id: '146', district: '楊梅區', name: '瑞塘國小', level: '國小', status: '已完工', budgetSource1: '市府預算', budgetSource2: '其他基金', budgetAmount: 90, startDate: '2024/01/15', endDate: '2024/02/19', agency: '區公所', source: [], features: { pole: false, shelter: false, light: false, pickup: false }, scheduleMonth: '', isExcluded: false, isNotApproved: false },
  { id: '147', district: '龍潭區', name: '雙龍國小', level: '國小', status: '規劃中', budgetSource1: '中央補助', budgetSource2: '國土署', budgetAmount: 2000, startDate: '2026/03/16', endDate: '2026/08/08', agency: '養工處', source: [], features: { pole: false, shelter: false, light: false, pickup: false }, scheduleMonth: '', isExcluded: false, isNotApproved: false },
  { id: '148', district: '龍潭區', name: '龍星國小', level: '國小', status: '規劃中', budgetSource1: '市府預算', budgetSource2: '公務預算', budgetAmount: 145, startDate: '', endDate: '', agency: '養工處', source: [], features: { pole: false, shelter: false, light: false, pickup: false }, scheduleMonth: '', isExcluded: false, isNotApproved: false },
  { id: '149', district: '龍潭區', name: '龍潭國小', level: '國小', status: '規劃中', budgetSource1: '中央補助', budgetSource2: '國土署', budgetAmount: 1500, startDate: '', endDate: '', agency: '客家事務局', source: [], features: { pole: false, shelter: false, light: false, pickup: false }, scheduleMonth: '', isExcluded: false, isNotApproved: false },
  { id: '150', district: '龍潭區', name: '龍潭高中', level: '高中', status: '規劃中', budgetSource1: '市府預算', budgetSource2: '公務預算', budgetAmount: 1500, startDate: '2026/03/16', endDate: '2026/08/08', agency: '養工處', source: [], features: { pole: false, shelter: false, light: false, pickup: false }, scheduleMonth: '', isExcluded: false, isNotApproved: false },
  { id: '151', district: '龍潭區', name: '三和國小', level: '國小', status: '規劃中', budgetSource1: '市府預算', budgetSource2: '公務預算', budgetAmount: 0, startDate: '', endDate: '', agency: '養工處', source: [], features: { pole: false, shelter: false, light: false, pickup: false }, scheduleMonth: '', isExcluded: false, isNotApproved: false },
  { id: '152', district: '龍潭區', name: '高原國小', level: '國小', status: '已完工', budgetSource1: '市府預算', budgetSource2: '統籌分配', budgetAmount: 250, startDate: '2024/03/01', endDate: '2024/04/30', agency: '養工處', source: [], features: { pole: false, shelter: false, light: false, pickup: false }, scheduleMonth: '', isExcluded: false, isNotApproved: false },
  { id: '153', district: '龍潭區', name: '諾瓦國小', level: '國小', status: '已完工', budgetSource1: '市府預算', budgetSource2: '統籌分配', budgetAmount: 62, startDate: '2023/11/01', endDate: '2023/11/30', agency: '養工處', source: [], features: { pole: false, shelter: false, light: false, pickup: false }, scheduleMonth: '', isExcluded: false, isNotApproved: false },
  { id: '154', district: '龍潭區', name: '龍潭國中', level: '國中', status: '已完工', budgetSource1: '市府預算', budgetSource2: '其他基金', budgetAmount: 200, startDate: '2023/07/07', endDate: '2023/08/31', agency: '區公所', source: [], features: { pole: false, shelter: false, light: false, pickup: false }, scheduleMonth: '', isExcluded: false, isNotApproved: false },
  { id: '155', district: '復興區', name: '羅浮高中', level: '高中', status: '已完工', budgetSource1: '市府預算', budgetSource2: '其他基金', budgetAmount: 125, startDate: '2024/05/10', endDate: '2024/08/23', agency: '養工處', source: [], features: { pole: false, shelter: false, light: false, pickup: false }, scheduleMonth: '', isExcluded: false, isNotApproved: false },
  { id: '156', district: '復興區', name: '羅浮國中', level: '國中', status: '已完工', budgetSource1: '市府預算', budgetSource2: '其他基金', budgetAmount: 125, startDate: '2024/05/10', endDate: '2024/08/23', agency: '養工處', source: [], features: { pole: false, shelter: false, light: false, pickup: false }, scheduleMonth: '', isExcluded: false, isNotApproved: false },
  { id: '157', district: '復興區', name: '羅浮國小', level: '國小', status: '已完工', budgetSource1: '市府預算', budgetSource2: '其他基金', budgetAmount: 125, startDate: '2024/05/10', endDate: '2024/08/23', agency: '養工處', source: [], features: { pole: false, shelter: false, light: false, pickup: false }, scheduleMonth: '', isExcluded: false, isNotApproved: false },
  { id: '158', district: '復興區', name: '羅浮附幼', level: '幼兒園', status: '已完工', budgetSource1: '市府預算', budgetSource2: '其他基金', budgetAmount: 125, startDate: '2024/05/10', endDate: '2024/08/23', agency: '養工處', source: [], features: { pole: false, shelter: false, light: false, pickup: false }, scheduleMonth: '', isExcluded: false, isNotApproved: false },
  { id: '159', district: '復興區', name: '霞雲國小', level: '國小', status: '已完工', budgetSource1: '中央補助', budgetSource2: '公路局', budgetAmount: 400, startDate: '2025/01/15', endDate: '2025/02/26', agency: '養工處', source: [], features: { pole: false, shelter: false, light: false, pickup: false }, scheduleMonth: '', isExcluded: false, isNotApproved: false },
];
...
export default function App() {
    ...
    reader.onload = (event) => {
      ...
      for (let i = 1; i < lines.length; i++) {
        ...
        newProjects.push({
          ...
          source: cols[14] ? cols[14].split(';').filter(Boolean) : [], // 支援多重標籤的匯入
          features: { pole: false, shelter: false, light: false, pickup: false }
        });
      }
  ...
  const exportCSV = () => {
    const headers = ['ID', '行政區', '案名', '層級', '狀態', '預算來源(大項)', '預算來源(細項)', '經費(萬)', '開工日', '完工日', '執行機關', '預計完工月份', '排除歸戶', '不核定', '案件來源'];
    const rows = projects.map(p => [ 
        ...
        Array.isArray(p.source) ? p.source.join(';') : (p.source || '') // 將陣列轉為字串備份
    ]);
...
請根據以上資料精準回答使用者的問題。若使用者要求「撰寫新聞稿」，請將上傳的參考資料融合當前的數據亮點，寫出一篇排版精美、結構清晰、適合發布給媒體的官方新聞稿。`;
  ...
  // ==========================================
  // 螢幕與列印共用的區塊 (重構為 Render 函數以避免 Vercel 報錯)
  // ==========================================
